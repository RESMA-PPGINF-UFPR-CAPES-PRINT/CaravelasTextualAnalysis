# -*- coding: utf-8 -*-
"""
EXPERIMENTO COM REGRESSAO LOGISTICA
Usa base bruta sem pré-processamentos
...
FILE_HISTORICO = 'historico/tfidf_exp_limpeza.csv'
colunas = ['texto','ponto','lower','underline_sequencia', 'underline','emoji_separado','alfanum']
